      ...
      000003 02 00 74         [24]  301 	ljmp	_main
                                    ...
                                    309 ;------------------------------------------------------------
                                    310 ;time                      Allocated to registers 
                                    311 ;------------------------------------------------------------
                                    312 ;	main.c:3: void delay(unsigned int time) {
                                    313 ;	-----------------------------------------
                                    314 ;	 function delay
                                    315 ;	-----------------------------------------
      000062                        316 _delay:
      ...
      000073 22               [24]  339 	ret
                                    ...
                                    342 ;------------------------------------------------------------
                                    343 ;i                         Allocated to registers r6 r7 
                                    344 ;------------------------------------------------------------
                                    345 ;	main.c:7: void main() {
                                    346 ;	-----------------------------------------
                                    347 ;	 function main
                                    348 ;	-----------------------------------------
      000074                        349 _main:
                                    350 ;	main.c:9: for(i = 0; i < 10; i++) {
      000074 7E 00            [12]  351 	mov	r6,#0x00
      000076 7F 00            [12]  352 	mov	r7,#0x00
      000078                        353 00102$:
                                    354 ;	main.c:10: P1 = 0x55;
      000078 75 90 55         [24]  355 	mov	_P1,#0x55
                                    356 ;	main.c:11: delay(50000);
      00007B 90 C3 50         [24]  357 	mov	dptr,#0xc350
      00007E C0 07            [24]  358 	push	ar7
      000080 C0 06            [24]  359 	push	ar6
      000082 12 00 62         [24]  360 	lcall	_delay
                                    361 ;	main.c:12: P1 = 0xAA;
      000085 75 90 AA         [24]  362 	mov	_P1,#0xaa
                                    363 ;	main.c:13: delay(50000);
      000088 90 C3 50         [24]  364 	mov	dptr,#0xc350
      00008B 12 00 62         [24]  365 	lcall	_delay
      00008E D0 06            [24]  366 	pop	ar6
      000090 D0 07            [24]  367 	pop	ar7
                                    368 ;	main.c:9: for(i = 0; i < 10; i++) {
      000092 0E               [12]  369 	inc	r6
      000093 BE 00 01         [24]  370 	cjne	r6,#0x00,00111$
      000096 0F               [12]  371 	inc	r7
      000097                        372 00111$:
      000097 C3               [12]  373 	clr	c
      000098 EE               [12]  374 	mov	a,r6
      000099 94 0A            [12]  375 	subb	a,#0x0a
      00009B EF               [12]  376 	mov	a,r7
      00009C 64 80            [12]  377 	xrl	a,#0x80
      00009E 94 80            [12]  378 	subb	a,#0x80
      0000A0 40 D6            [24]  379 	jc	00102$
                                    380 ;	main.c:15: }
      0000A2 22               [24]  381 	ret
                                    382 	.area CSEG    (CODE)
                                    383 	.area CONST   (CODE)
                                    384 	.area XINIT   (CODE)
